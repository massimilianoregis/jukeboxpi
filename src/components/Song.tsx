...
export const Song: React.FC<ISong> = ({ title, author, status, onStatus, onNext }) => <IonItem lines='none' className='ion-text-center' color="primary">
  ...
  <IonButton slot="end" onClick={() => onNext()} fill="clear" color="light"><IonIcon slot="icon-only" icon={playSkipForward}></IonIcon></IonButton>
</IonItem>;
